...
class Sortable {
    static regex_dir = / dir-(u|d) /
    static reClassify(element, dir) {
        element.className = element.className.replace(Sortable.regex_dir, '') + dir
    }

    static getValue(element, alt_sort) {
        ...
        if (element.nodeName === 'TH') {
            ...
            try {
                ...
                if (regex_table.test(table.className)) {
                    ...
                    Sortable.reClassify(element, dir)
                    ...
                    rows.sort(function(a, b) {
                        var x = Sortable.getValue((reverse ? a : b).cells[column_index], alt_sort)
                        var y = Sortable.getValue((reverse ? b : a).cells[column_index], alt_sort)
